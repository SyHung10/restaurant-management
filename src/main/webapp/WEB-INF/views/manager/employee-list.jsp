        ...
        <body>
            <div class="manager-layout">
                ...
                <div class="manager-main">
                    ...
                    <div class="manager-header">
                        <div class="page-header">
                            ...
                            <p class="page-subtitle">Quản lý thông tin và phân quyền nhân viên</p>
                        </div>
                        <div class="header-actions">
                            ...
                            <a href="${pageContext.request.contextPath}/manager/employees/new" class="btn btn-primary">
                        ...
                        <div class="grid grid-cols-4 mb-xl">
                            <div class="card">
                                <div class="card-body text-center">
                                    <div class="text-2xl font-bold text-gray-900">${employees.size()}</div>
                ...
                <c:forEach var="employee" items="${employees}">
                    <tr>
                                                <td>
                                                    <span class="font-semibold text-gray-700">#${employee.employeeId}</span>
                                                </td>
                                                <td>
                                                    <div class="flex items-center gap-md">
                                                        <div style="width: 50px; height: 50px; border-radius: 50%; background: linear-gradient(135deg, var(--primary-color), var(--secondary-color)); display: flex; align-items: center; justify-content: center; color: white; font-weight: 600; font-size: 1.2rem;">
                                                ...
                                                <td>
                                                    <c:choose>
                                                        ...
                                                        <c:otherwise>
                                                            <span class="badge badge-gray">${employee.role}</span>
                                                        </c:otherwise>
                                                    </c:choose>
                                                </td>
                                                <td>
                                                    <div class="font-medium text-gray-900">${employee.username}</div>
                                                ...
                                                <td>
                                                    <div class="flex gap-sm">
                                                        <a href="${pageContext.request.contextPath}/manager/employees/edit/${employee.employeeId}" 
                                                           class="btn btn-sm btn-secondary"
                                                           title="Chỉnh sửa thông tin">
                                                            <i class="fas fa-edit"></i>
                                                        </a>
                            <a href="${pageContext.request.contextPath}/manager/employees/delete/${employee.employeeId}"
                        ...
                        <c:if test="${empty employees}">
                            <div class="card text-center p-xl">
                                ...
                                <h3 class="text-xl font-semibold text-gray-700 mb-md">Chưa có nhân viên nào</h3>
                                <p class="text-gray-500 mb-lg">Thêm nhân viên đầu tiên để bắt đầu quản lý</p>
                                <a href="${pageContext.request.contextPath}/manager/employees/new" class="btn btn-primary">
                                    <i class="fas fa-user-plus"></i>
            ...
            <script src="${pageContext.request.contextPath}/resources/js/manager/employee-list.js"></script>
        </body>
