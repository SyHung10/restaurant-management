// JavaScript cho modal thanh toán - không dùng AJAX, chỉ form submission
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (paymentErrorAlert && paymentErrorAlert.textContent.includes('Lỗi thanh toán')) {
...
function validatePaymentForm() {
    ...
    const confirmation = confirm(
        ...
        'Phương thức: ' + (paymentMethod.value === 'CASH' ? 'Tiền mặt' : 'Thẻ') + '\n' +
...
function resetPaymentButton() {
    ...
    if (submitBtn) {
        ...
        submitBtn.innerHTML = '<i class="fas fa-credit-card"></i> Xác nhận thanh toán';
    }
}
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const paymentBtns = document.querySelectorAll('[data-target="#paymentModal"]');
...
if (window.location.hostname === 'localhost') {
    console.log('Payment Modal JS loaded - No AJAX mode');
} 